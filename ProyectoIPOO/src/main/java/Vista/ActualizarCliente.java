...
public class ActualizarCliente extends javax.swing.JDialog {
    ...
    public ActualizarCliente(java.awt.Frame parent, boolean modal, AdmAplicacion admAplicacion) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        cbMes.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"N/A", "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre" }));

        String[] annos = new String[103];
        annos[0] ="N/A";
        for(int i = 102; i>=1; i--){
            annos[i] = String.valueOf((i+1919));
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String nombre, direccion,correo, cedula, telefono, dia, anno, mes;
        char sexo;
        try{
            ...
            telefono = this.txfTelefono.getText();
            cedula = this.txfCedula.getText();
            dia = (String) this.cbDia.getSelectedItem();
            anno = (String) this.cbAnno.getSelectedItem();
            mes = (String) this.cbMes.getSelectedItem();
            String resultado;
            resultado = this.admAplicacion.getAdmCounter().actualizarCliente(cedula, nombre, correo, telefono, direccion, sexo, dia, mes, anno);
            if(resultado.contains("Cliente actualizado")){
