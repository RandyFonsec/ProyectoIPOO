...
public class Counter {
    ...
    public Counter(String nombre, String cedulaJuridica, int cantidadCasilleros, int paquetesNivel) {
        this.nombre = nombre;
        this.cedulaJuridica = cedulaJuridica;
        this.cantidadCasilleros = cantidadCasilleros;
        this.paquetesNivel = paquetesNivel;
    ...
    public String toString() {
        return "Counter{" + "nombre=" + nombre + ", cedulaJuridica=" + cedulaJuridica + ", direccion=" + direccion + ", casilleros=" + casilleros + ", clientes=" + clientes + ", cantidadCasilleros=" + cantidadCasilleros + ", paquetesNivel=" + paquetesNivel + '}';
    }
